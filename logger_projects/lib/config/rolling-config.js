const { RollingTimeOptions, RollingSizeOptions } = require("../lib/utils/rolling-options");
...
class RollingConfig {
   ...
   *
   */
  #time_threshold = RollingTimeOptions.Fiveseconds;
  ...
  /**
   * @returns {number} The current time threshold in seconds.
   */
  get time_threshold() {
  ...
  /**
   * @returns {number} The current size threshold in bytes.
   */
  get size_threshold() {
